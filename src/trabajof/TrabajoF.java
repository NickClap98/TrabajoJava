...
public class TrabajoF {
    ...
    public static void main(String[] args) {
        ...
        ArmaCorta armaCorta1 = new ArmaCorta(policia1, 9, 9, 50, "Desert Eagle", "EN USO", false);
        ArmaCorta armaCorta2 = new ArmaCorta(policia1, 20, 3, 45, "Glock 18", "NO", true);
   ...
   // AGREGARLE UN ARMA A ALGUN POLICIA
     policia2.agregarArma(armaLarga1); //AGREGA A TONY LA M4A1
        ...
        policia2.mostrarArmas(); //Armas de tony
         armaLarga1.MostrarInfo(""); // mostrar info de armalarga1 que tiene tony
